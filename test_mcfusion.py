...
def main():
    ...
    # parser.add_argument('--dataset', type=str, default='TNO',help='input test image name')
    # parser.add_argument('--dataset', type=str, default='RoadScene', help='input test image name')
    parser.add_argument('--dataset', type=str, default='TNO', help='input test image name')
    # parser.add_argument('--dataset', type=str, default='M3FD', help='input test image name')

    parser.add_argument('--A_dir', type=str, default='ir',
                        help='input test image name')
    parser.add_argument('--B_dir', type=str, default='vi',help='input test image name')
