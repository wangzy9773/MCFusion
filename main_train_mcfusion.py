...
def main(json_path='options/swinir/train_mcfusion_vif.json'):
    ...
    parser.add_argument('--dist', default=False)  # 是否多卡

    # parser.add_argument('--nproc_per_node', default=3)
    # parser.add_argument('--master_port', default=1234)
    ...
    for epoch in range(300):  # keep running
        for i, train_data in enumerate(train_loader):
            ...
            # -------------------------------
            # 2) feed patch pairs 把数据放到GPU上运行
            # -------------------------------
            ...
            # -------------------------------
            # 4) training information #每一千轮打印一次信息
            # -------------------------------
